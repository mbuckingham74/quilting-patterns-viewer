      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-purple-100 p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Pattern Triage - Prominent placement */}
            <Link
              href="/admin/triage"
              className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-100 to-rose-100 hover:from-purple-200 hover:to-rose-200 rounded-lg transition-colors border border-purple-200"
            >
              ...
              <div>
                <p className="font-medium text-stone-800">Pattern Triage</p>
                <p className="text-sm text-stone-500">Fix issues in one place</p>
              </div>
              {totalQaIssues > 0 && (
