...
export default function FailedSearchesList({ searches, totalFailed, error, errorMessage }: FailedSearchesListProps) {
    ...
    <div className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
      ...
      {error ? (
        <div className="text-center py-8">
          ...
          <p className="text-stone-500 text-sm">{errorMessage || 'Unable to load failed searches'}</p>
